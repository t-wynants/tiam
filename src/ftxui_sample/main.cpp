...
// configuration step. It creates a namespace called `tiam`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tiam::cmake::project_name, tiam::cmake::project_version) };
